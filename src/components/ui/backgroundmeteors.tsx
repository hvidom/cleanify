...
export default function BackgroundMeteors({
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 flex h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-black">
      <div
        ...
        >
          <div
            className="h-14 w-px rounded-full
              bg-linear-to-t from-indigo-500 via-teal-500 to-transparent
